...
import { Info, ChevronDown, Star, Trophy } from "lucide-react";
...
const ScoreExplainer = () => {
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen} className="mb-8">
      <CollapsibleTrigger className="flex items-center gap-2 text-muted-foreground hover:text-foreground transition-colors group w-full">
